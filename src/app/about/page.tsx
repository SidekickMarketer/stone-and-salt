      ...
      <section className="py-20 bg-soft-cream">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="aspect-[4/3] bg-eucalyptus/20 rounded-2xl flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="mt-4 text-slate/50">[Team/Owner Photo]</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="order-2 lg:order-1">
              <div className="aspect-[4/3] bg-eucalyptus/20 rounded-2xl flex items-center justify-center">
                <div className="text-center p-8">
                  ...
                  <p className="mt-4 text-slate/50">[Local Area Photo]</p>
                </div>
              </div>
            </div>

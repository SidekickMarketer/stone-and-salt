...
export const metadata: Metadata = {
  ...
  description:
    "Stone & Salt serves Greater Cincinnati including Liberty Township, Mason, West Chester, Blue Ash, Indian Hill, Loveland, Oxford, Waynesville, and surrounding areas.",
  openGraph: {
